    ...
    <AuthLayout>
      <AuthCard>
        ...
        <div className="space-y-4">
          ...
          <button onClick={handle} disabled={loading} className="btn-primary mt-2">
            {loading ? "Creating..." : "Sign up"}
          </button>
          <p className="text-center text-sm text-[#6B7280]">
            Got an account? <Link to="/login" className="font-semibold text-[#0D1B2A] hover:underline">Sign in</Link>
          </p>
        </div>
      </AuthCard>
    </AuthLayout>
